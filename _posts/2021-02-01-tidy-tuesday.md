...
subtitle: For #tidytuesday, I visualised where trash comes from and where it ends up.
...
For this week's [#tidytuesday](https://github.com/rfordatascience/tidytuesday) I am visualising the vast dataset of rubbish collected on the beaches all over the world.

I will leave out the technical details (check th tweet / Rpubs post for code) of how this was achieved, but the result can be seen in the tweet below.

The data shows the headquarters for each company that was identified, and the lines show where the trash was found. The more dots that move along the line, the more trash that has been found in those locations from those companies.
